    ...
    <div class="fadeIn" v-cloak>
      ...
      <div v-if="!loading && !errored">
        ...
        <ul id="filter-buttons" class="list-inline m-t-md">
          ...
          <li v-if="selectedType" class="list-inline-item">
            <button
          ...
          >
            <div class="card h-100 shadow">
              <img
                ...
                v-bind:alt="items.animal_name + ' the ' + items.animal_type"
                loading="lazy"
              />

              <div class="card-body pb-1">
                <h3 v-bind:id="items.animal_name" class="card-title float-left">
              ...
              <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4
                      class="modal-title float-left"
                      v-bind:id="'label' + items.animal_id"
                    >
                      {{ items.animal_name || items.animal_id }}
                      <img
                      v-if="items.temperament"
                  ...
                  <div class="modal-body">
                    ...
                    >
                      <img
                        v-bind:alt="
                          items.animal_name + ' the ' + items.animal_type
                        "
                        :src="items.image.url"
...
export default {
  ...
  computed: {
    ...
    computed_items: function () {
      ...
      const filterLocation = this.selectedLocation
      const filterTemp = this.selectedTemp
      const filterAge = this.selectedAge
      const filterSex = this.selectedSex
          ...
          if (filterSex && filterSex.length > 0) {
            if (item.animal_gender !== undefined) {
              if (filterSex === '') {
                ...
                if (
                  item.animal_gender.toString().toLowerCase().includes('female')
                ) {
                  var female = 'female'
                ...
                if (
                  item.animal_gender
                    ...
                    .toLowerCase()
                    .includes('neutered') ||
                  item.animal_gender.toString().toLowerCase().startsWith('m')
                ) {
                  var male = 'male'
